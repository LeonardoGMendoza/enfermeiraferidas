...
export default function LandingPage() {
  ...
  return (
    <div className="landing">
      ...
      {/* ── Mobile Menu Dropdown ── renderizado só quando aberto */}
      {mobileMenuOpen && (
        <>
        ...
        <div className="hc-cta glass">
          <div className="hc-cta-content">
            ...
            <p className="hc-cta-text">
              ...
              de farmácias, plataformas de saúde e clínicas especializadas.
            </p>
            <div className="hc-cta-benefits">
              ...
              <div className="hc-benefit">
                <span className="hc-benefit-dot" style={{background: 'var(--info)'}} />
                Parceria com redes de drogarias
              </div>
              <div className="hc-benefit">
                <span className="hc-benefit-dot" style={{background: 'var(--info)'}} />
                Atendimento complementar a clínicas
              </div>
            </div>
            <a
